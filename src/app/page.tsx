...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-4 bg-black min-h-screen text-gray-300 ">
    ...
    <section className="space-y-8 ">
      ...
      <div className="space-y-2 animate-pulse">
        ...
        <div className="flex gap-1 text-2xl items-end ">
          <div className="h-6 w-24 bg-black rounded"></div>
          <div className="h-6 w-24 bg-black rounded"></div>
        </div>
      ...
      <div className="flex flex-col gap-4 animate-pulse">
        <p className="text-2xl h-8 w-36 bg-black rounded"></p>

        {[1, 2, 3, 4, 5, 6, 7].map((index) => (
          <div key={index} className="grid grid-cols-2 md:grid-cols-4 gap-4 ">
            <div className="h-8 w-28 bg-black rounded"></div>
